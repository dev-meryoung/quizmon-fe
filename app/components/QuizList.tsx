...
import styles from 'app/styles/quizList.module.scss';

const QuizList = (): React.ReactNode => {
  return (
              ...
              <div className={styles.answers}>
                ...
                <div className={styles.shortAnswer}>
                  <input
                    ...
                    spellCheck="false"
                    onChange={(e) => {
                      onChangeAnswer(i, 0, e);
                    }}
                  />
                </div>
                {qnaArray[i].answerArray.length > 1 ? (
                  <div className={styles.shortAnswer}>
                    <input
                      name={`${i}`}
                      className={styles.shortAnswer_text}
                ...
                {qnaArray[i].answerArray.length === 3 ? (
                  <div className={styles.shortAnswer}>
                    <input
                      name={`${i}`}
                      className={styles.shortAnswer_text}
